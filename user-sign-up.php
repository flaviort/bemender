							...
							<div class="select wow fadeInUp">
								...
								<div class="line">
									...
									<select id="user-or-provider">
										<option value="user-sign-up" selected>User</option>
										<option value="provider-sign-up">Provider</option>
									</select>
						...
						<div class="col-lg-6 left">
							<form action="" class="sign-up">
								...
								<div class="final wow fadeInUp">
									<p class="text-medium">
										Already have an account? <a href="user-sign-in.php" class="text-medium hvr-underline-from-left">Sign in</a>
									</p>
								</div><!-- END FINAL -->
