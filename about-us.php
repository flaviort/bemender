					...
					<div class="container container-big">
						<div class="row">
							...
							<div class="col-12 mob">
								...
								<img src="assets/img/about-us-top-man.png" alt="Man" class="man wow fadeInLeft">
								<img src="assets/img/about-us-top-woman.png" alt="Woman" class="woman wow fadeInRight">
							...
							<div class="col-md-4 left wow fadeInUp">
								...
								<img src="assets/img/about-us-top-man.png" alt="Man" class="person">
							...
							<!-- COL / RIGHT -->
							<div class="col-md-4 right wow fadeInUp" data-wow-delay=".4s">
				...
				<div class="how-it">
					<div class="container container-big">
						<div class="row">
							...
							<!-- COL / RIGHT -->
							<div class="col-md-push-6 col-md-6 right">
							...
							<!-- COL / LEFT -->
							<div class="col-md-pull-6 col-md-6 left">
							...
							<div class="col-12 bottom">
								...
								<div class="gray-block wow fadeInUp">
									<img src="assets/img/about-us-group.png" alt="Group of people">
								</div>
					...
					<div class="container container-big">
						<div class="row">
							...
							<div class="col-md-6 left wow fadeInUp">
								...
								<img src="assets/img/about-us-phone.png" alt="Gustavo Serra">
							...
							<div class="col-md-6 right">
								...
								<p class="text-medium wow fadeInUp">
									Our mission is to ensure people get the best service for the best price by shortening the distance and time between the provider and the consumer.
								</p>
								...
								<div class="links">
									...
									<a href="#" target="_blank" class="wow fadeInUp" data-wow-delay=".2s">
