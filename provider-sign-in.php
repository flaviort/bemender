							...
							<div class="select wow fadeInUp">
								...
								<div class="line">
									...
									<select id="user-or-provider">
										<option value="user-sign-in">User</option>
										<option value="provider-sign-in" selected>Provider</option>
									</select>
						...
						<div class="col-lg-6 left">
							<form action="">
								...
								<div class="line wow fadeInUp">
									...
									<a href="provider-forgot-password.php" class="forgot text-medium-small">Forgot password?</a>
								</div>

								<input type="submit" id="send-provider" style="display: none;">
								<!--label for="send-provider" class="purple-bt text-medium wow fadeInUp">Sign in</label-->
								<a href="dashboard-provider-profile.php" class="purple-bt text-medium wow fadeInUp">Sign in</a>
