	...
	<body class="internal hire">
		<div class="wrap">
						...
						<div class="col-12">
							...
							<div id="before-hire">
								...
								<div class="box">
									...
									<!-- LINE -->
									<div class="line" id="line-payment">
							...
							<div id="after-hire">
								...
								<p class="text-x-medium">
									<strong>Your Mender has been successfully hired!</strong><br /><br />

									On the scheduled day and time you will receive a message about your service.
								</p>
			...
			<section id="content">
				...
				</section><!-- END SECTION / SLIDER SECTION -->
			...
			</div><!-- END ADD NEW CARD -->

			<!-- SEARCHING MENDER -->
			<div id="searching-mender">
				<div class="box">
				...
				<div class="box">
					...
					<div class="top-row">
						...
						<div class="photo">
							...
							<div class="image" style="background-image: url(assets/img/cleanner.jpg);"></div>
						...
						<div class="infos">
							...
							<a href="provider-details.php" class="text-medium">
			...
			</div><!-- END MENDER PROFILE -->

			<!-- INVOICE -->
			<div id="invoice">
				<div class="box">

					<p class="title text-large">
						Invoice
					</p>
					...
					<div class="line">
						<div class="inner-box">
							...
							<div class="row inner-row">
								...
								<!-- COL / INNER LEFT -->
								<div class="col-xl-6 inner-left">

									<p class="text-x-medium name">
										Jane Doe
									</p>
								...
								</div><!-- END COL / INNER LEFT -->

								<!-- COL / INNER RIGHT -->
								<div class="col-xl-6 inner-right">
									<div class="service">
										<div class="row">
											...
											<div class="col-sm-5 col-xl-6">
												...
												<img src="assets/img/services/home-services/cleaning-and-housekeeping.jpg" alt="Cleanning & House-Keeping">

											</div><!-- END COL -->

										</div><!-- END ROW -->
									</div><!-- END SERVICE -->
								</div><!-- END COL / INNER RIGHT -->
						...
						<div class="row">
							...
							<div class="col-lg-7">
								<div class="input-line">
									...
									<p class="text-medium label">
										Service
									</p>

									<p class="text-medium data">
										Cleaning & House-Keeping
									</p>
					...
					<button class="purple-bt text-x-medium">
						pay
					</button>
				...
				<div class="box">
					<form action="">
							...
							<div class="row">
								...
								<div class="col-lg-4">
									<div class="rating-line">
										...
										<label for="rating-1" id="1-star" class="checked">
											<img src="assets/img/svg/icon-star.svg" alt="1 Star" class="svg">
										</label>

										<input type="radio" name="rating" id="rating-2">
										<label for="rating-2" id="2-star" class="checked">
											<img src="assets/img/svg/icon-star.svg" alt="2 Stars" class="svg">
										</label>

										<input type="radio" name="rating" id="rating-3" checked>
										<label for="rating-3" id="3-star" class="checked">
											<img src="assets/img/svg/icon-star.svg" alt="3 Stars" class="svg">
										</label>

										<input type="radio" name="rating" id="rating-4">
										<label for="rating-4" id="4-star">
											<img src="assets/img/svg/icon-star.svg" alt="4 Stars" class="svg">
										</label>

										<input type="radio" name="rating" id="rating-5">
										<label for="rating-5" id="5-star">
											<img src="assets/img/svg/icon-star.svg" alt="5 Stars" class="svg">
										</label>
								...
								<!-- COL -->
								<div class="col-12">
									<textarea class="text-medium textarea" placeholder="Add Review"></textarea>
								</div><!-- END COL -->
						...
						<div class="last-buttons">
							...
							<button class="hollow-purple-bt text-medium left" onclick="$.fancybox.close();">
								Rate Later
							</button>

							<button class="purple-bt text-medium right" onclick="$.fancybox.close();">
								Send
							</button>
							
							<div class="cf"></div>

						</div><!-- END LAST BUTTONS -->
