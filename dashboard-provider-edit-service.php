												...
												<div class="col-12 wow fadeInUp">
													...
													<div class="line">
														...
														<select required class="text-medium">
															...
															<option value="House Services" selected>House Services</option>
												...
												<div class="row">
													...
													<div class="col-6 col-md-4 col-lg-3 wow fadeInUp">
														<div class="box">
															...
															<div class="overlay">
																<div class="wrap">
																	...
																	<div class="actions">
																		...
																		<button class="text-small hvr-underline-from-left">
																			Yes
																		</button>
															...
															<!-- DELETE -->
															<button class="delete">
																<img src="assets/img/svg/icon-trash.svg" alt="Delete" class="svg">
															</button><!-- END DELETE -->
